  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-emerald-800 to-teal-900 text-white shadow-2xl z-50 lg:translate-x-0 lg:static lg:z-auto"
      >
        {/* Logo */}
